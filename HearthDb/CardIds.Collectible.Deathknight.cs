    ...
    public partial class CardIds
    {
        public partial class Collectible
        {
            public class Deathknight
            {
                ...
                public const string NerubianSwarmguardCorePlaceholder = "CORE_RLK_062";
                public const string FrostwyrmsFuryCorePlaceholder = "CORE_RLK_063";
                public const string HematurgeCorePlaceholder = "CORE_RLK_066";
                public const string FrostmourneCorePlaceholder = "CORE_RLK_086";
                public const string AsphyxiateCorePlaceholder = "CORE_RLK_087";
                public const string NecroticMorticianCorePlaceholder = "CORE_RLK_116";
                public const string AcolyteOfDeathCorePlaceholder = "CORE_RLK_121";
                public const string TheScourgeCorePlaceholder = "CORE_RLK_122";
                public const string CorpseBrideCorePlaceholder = "CORE_RLK_504";
                public const string MarrowManipulatorCorePlaceholder = "CORE_RLK_505";
                public const string BloodTapCorePlaceholder = "CORE_RLK_712";
                ...
                public const string HeartStrikeCorePlaceholder = "LEG_RLK_034";
                public const string CorruptedAshbringerCorePlaceholder = "LEG_RLK_067";
                public const string PatchwerkCorePlaceholder = "LEG_RLK_071";
                public const string PossessifierCorePlaceholder = "LEG_RLK_077";
                public const string LordMarrowgarLegacy = "LEG_RLK_085";
                public const string DefrostCorePlaceholder = "LEG_RLK_101";
                public const string RepulsiveGargantuanCorePlaceholder = "LEG_RLK_115";
                public const string ObliterateCorePlaceholder = "LEG_RLK_125";
                public const string OverseerFrigidaraCorePlaceholder = "LEG_RLK_224";
                public const string YmirjarDeathbringerCorePlaceholder = "LEG_RLK_226";
                public const string GraveyardShiftCorePlaceholder = "LEG_RLK_705";
                public const string RimefangSwordCorePlaceholder = "LEG_RLK_710";
                public const string RuneforgingCorePlaceholder = "LEG_RLK_715";
                public const string RimeSculptorCorePlaceholder = "LEG_RLK_752";
                public const string BonediggerGeistCorePlaceholder = "LEG_RLK_753";
